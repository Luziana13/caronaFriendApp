// src/screens/pesquisarPessoa/SearchScreen.js
...
const SearchScreen = (props) => {
    ...
    const [assets] = useAssets([require('../../../assets/indexBusca.html')]);
    const [htmlString, setHtmlString] = useState('');
    const [modalVisible, setModalVisible] = useState(false);
    const [rota, setRota] = useState(null);
    const [searchDate, setSearchDate] = useState(new Date().toISOString().split('T')[0]);
    const [searchTime, setSearchTime] = useState(new Date().toISOString().split('T')[1].split('.')[0]);
            ...
            >
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        <Text style={styles.header}>Informações da Busca</Text>
                        <Text>Tipo de Busca: BUSCA</Text>
                        <TextInput
                            style={styles.input}
